require.def("vod/carousel",
    ...
    function (
        ...
        CarouselComponent = Component.extend({
            ...
            onBeforeShow: function (evt) {
                this._initialItem = this._args.initialItem || 0;
                this._dontShowYet(this._args);
                this.setDescription(this._args.description || "");
                this._createCarousel(this._args);
                this.appendChildWidget(this._carousel);
                this._addCarouselListeners();
                this._setCarouselAlignPoints();
                this._saveCarouselLengths();
                this._startCarouselDataBinding();
            },
    ...
    //            this._goBack();
            ...
            _setCarouselAlignPoints: function (evt) {
                if (this._args && this._args.alignment) {
                    var alignPoint = this._args.alignment.alignPoint;
                    var normalisedAlignPoint = this._args.alignment.normalisedAlignPoint;
                    var normalisedWidgetAlignPoint = this._args.alignment.normalisedWidgetAlignPoint;
            ...
            _saveCarouselLengths: function (evt) {
                this._lengths = this._args.lengths;
            },
            ...
            _startCarouselDataBinding: function (evt) {
                ...
                dataSource = this._args.dataSource;
                formatter = this._args.formatter;
