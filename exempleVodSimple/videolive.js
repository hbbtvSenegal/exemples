        ...
        return Component.extend({
            ...
            _onBeforeRender: function (evt) {
              //  console.log(evt.args.videoUrl);
                ...
                var sources = new VideoSource(evt.args.videoUrl, evt.args.videoType);
                player.setSources([sources]);
           //     console.log(sources.isLiveStream());
             //   console.log(player.getSources());
